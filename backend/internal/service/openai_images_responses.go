...
// openAIImagesOAuthUnavailableDefaultCooldown.
//
...
// (IsOpenAIImagesRetryableUpstreamError: status >= 500) and drives failover — so
// one such reply walks the pool and cools every account the retry touches.
