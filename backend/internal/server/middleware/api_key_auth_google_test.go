...
func TestAPIKeyAuthGoogle_MissingKey(t *testing.T) {
	gin.SetMode(gin.TestMode)
...
func TestAPIKeyAuthGoogle_QueryApiKeyRejected(t *testing.T) {
	gin.SetMode(gin.TestMode)
...
func TestAPIKeyAuthGoogleSetsGroupContext(t *testing.T) {
	gin.SetMode(gin.TestMode)
...
func TestAPIKeyAuthGoogle_QueryKeyAllowedOnV1Beta(t *testing.T) {
	gin.SetMode(gin.TestMode)
...
func TestAPIKeyAuthGoogle_InvalidKey(t *testing.T) {
	gin.SetMode(gin.TestMode)
...
func TestAPIKeyAuthGoogle_MarksUnavailableGroupBusinessLimited(t *testing.T) {
	gin.SetMode(gin.TestMode)
...
func TestAPIKeyAuthGoogle_RepoError(t *testing.T) {
	gin.SetMode(gin.TestMode)
...
func TestAPIKeyAuthGoogle_DisabledKey(t *testing.T) {
	gin.SetMode(gin.TestMode)
...
func TestAPIKeyAuthGoogle_TouchesLastUsedOnSuccess(t *testing.T) {
	gin.SetMode(gin.TestMode)
...
func TestAPIKeyAuthGoogle_TouchFailureDoesNotBlock(t *testing.T) {
	gin.SetMode(gin.TestMode)
...
func TestAPIKeyAuthGoogle_TouchesLastUsedInStandardMode(t *testing.T) {
	gin.SetMode(gin.TestMode)
