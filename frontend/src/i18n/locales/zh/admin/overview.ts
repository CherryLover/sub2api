export default {
    ...
    // Groups Management
    // 密钥总表（管理端所有用户的 API 密钥）
    apiKeys: {
      title: '密钥总表',
      description: '查看和管理所有用户的 API 密钥',
      searchPlaceholder: '搜索名称或密钥...',
      userFilterPlaceholder: '按用户邮箱筛选...',
      ...
      editKey: '编辑密钥',
      deleteKey: '删除密钥',
      deleteConfirmMessage: "确定要删除用户 {email} 的密钥 '{name}' 吗？此操作无法撤销。",
      group: '分组',
      ipRules: 'IP 规则',
      ipWhitelist: 'IP 白名单',
      ipWhitelistPlaceholder: '192.168.1.100\n10.0.0.0/8',
      ipWhitelistHint: '每行一个 IP 或 CIDR，设置后仅允许这些 IP 使用此密钥；留空表示不限制',
      ipBlacklist: 'IP 黑名单',
      ipBlacklistPlaceholder: '1.2.3.4\n5.6.0.0/16',
      ipBlacklistHint: '每行一个 IP 或 CIDR，这些 IP 将被禁止使用此密钥；留空表示不限制',
      saveIpRules: '保存 IP 规则',
      noKeys: '暂无密钥',
      noKeysDescription: '没有符合条件的 API 密钥',
      keyEnabled: '密钥已启用',
      keyDisabled: '密钥已停用',
      keyUpdated: '密钥已更新',
      keyUpdatedWithGrant: '密钥已更新，已自动为用户添加「{group}」分组权限',
      keyDeleted: '密钥已删除',
      failedToLoad: '加载密钥列表失败',
      failedToUpdate: '更新密钥失败',
      failedToDelete: '删除密钥失败'
    },
    groups: {
      title: '分组管理',
