export default {
    settings: {
      ...
      notifications: {
        ...
        accountUsageRules: {
          title: 'Account Usage Alert Rules',
          description: "Watch each account's window usage, quota, balance or today's cost, and push to your phone through the Bark channel above once a threshold is reached.",
          create: 'New Rule',
          createTiers: 'Create 3 Tiers',
          loading: 'Loading...',
          empty: 'No account usage rules yet. Start with "New Rule" or "Create 3 Tiers".',
