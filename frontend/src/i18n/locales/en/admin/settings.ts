    ...
    settings: {
      ...
      notifications: {
        bark: {
          ...
          deviceKeyPlaceholder: 'Copy the device key from the Bark app home screen',
          deviceKeyConfiguredPlaceholder: 'Configured. Leave blank to keep the current key.',
          deviceKeyConfigured: 'Configured',
          deviceKeyHint: 'The key is never shown again after saving. To rotate it, just enter a new one.',
