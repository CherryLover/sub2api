export default {
    accounts: {
      ...
      capacity: {
        ...
        load: {
          hoverHint: 'Hover for recent load, click for details',
          summary: 'Concurrency {current}/{max} · {count} requests in last {minutes} min · Top key {key}',
          summaryLoading: 'Loading recent load…',
          summaryFailed: 'Failed to load recent load, click for details',
          noKey: 'none',
          title: 'Capacity Load Details',
          concurrency: 'Concurrency',
          waiting: 'Waiting',
          windowMinutes: '{minutes} min',
          totalRequests: '{count} requests in window',
          byApiKey: 'By API Key',
          byModel: 'By Model',
          requests: 'Requests',
          requestsLimitHint: 'Showing latest {limit} only',
          columns: {
            time: 'Time',
            user: 'User',
            apiKey: 'API Key',
          ...
          emptyRequests: 'No requests in this time window',
          errors: 'Errors in Window',
          errorsEmpty: 'No errors in this time window',
          errorsFailed: 'Failed to load errors for this window; data above is unaffected',
          delayHint: 'Data comes from usage logs and may lag by a few seconds',
          loadFailed: 'Failed to load capacity data',
          retry: 'Retry',
          refresh: 'Refresh',
          count: '{count} req'
        },
      ...
      quotaLimitHint: 'Set daily/weekly/total spending limits (USD). Weekly limits default to the calendar week (Monday 00:00, server timezone). Anthropic API key accounts can also configure client affinity. Changing limits won\'t reset usage.',
      ...
      quotaWeeklyLimitHint: 'Rolling window: resets every 7 days from first usage (legacy; new weekly limits default to a fixed calendar-week reset).',
