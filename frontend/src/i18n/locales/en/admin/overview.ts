export default {
    ...
    dashboard: {
      ...
      groupPricingDesc: 'Configure group multipliers and media prices',
    ...
    // Groups
    // All API keys across users (admin)
    apiKeys: {
      title: 'All API Keys',
      description: 'View and manage API keys of all users',
      searchPlaceholder: 'Search name or key...',
      userFilterPlaceholder: 'Filter by user email...',
      ...
      deleteConfirmMessage: "Delete key '{name}' of {email}? This action cannot be undone.",
      group: 'Group',
      ipRules: 'IP Rules',
      ipWhitelist: 'IP Whitelist',
      ipWhitelistPlaceholder: '192.168.1.100\n10.0.0.0/8',
      ipWhitelistHint: 'One IP or CIDR per line; only these IPs may use the key. Leave empty for no restriction.',
      ipBlacklist: 'IP Blacklist',
      ipBlacklistPlaceholder: '1.2.3.4\n5.6.0.0/16',
      ipBlacklistHint: 'One IP or CIDR per line; these IPs are blocked from using the key. Leave empty for no restriction.',
      saveIpRules: 'Save IP Rules',
      noKeys: 'No API keys',
      noKeysDescription: 'No API keys match the current filters',
      keyEnabled: 'API key enabled',
      keyDisabled: 'API key disabled',
      keyUpdated: 'API key updated',
      keyUpdatedWithGrant: 'API key updated. User auto-granted access to "{group}"',
