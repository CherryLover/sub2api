...
| **批次 6** | A3 周额度自然周锚点、A6 后台单管理员化、A7 文档改写 + 压测 / 备份恢复 / Key 泄露演练 | 🔵 **进行中：A6-1 已启动、A6-2 第一步已启动**（2026-09-04），其余（A3 / A6 其余部分 / A7）未开始 |
...
- **第二步（⚪ 未开始）：账号用量阈值规则。** 把账号用量 / 额度接近上限做成可配置的告警规则，复用第一步的出口。
